...
dies_ok {CDD::Card->new(rank=>'A')} 'new full rank only dies';
dies_ok {CDD::Card->new(rank=>'A', suit=>'S')} 'new full rank suit only dies';
dies_ok {CDD::Card->new(rank=>11, suit=>'S', val=>1)} 'new full bad rank';
dies_ok {CDD::Card->new(rank=>10, suit=>'G', val=>1)} 'new full bad suit';
dies_ok {CDD::Card->new(rank=>10, suit=>'C', val=>0)} 'new full bad val 1';
dies_ok {CDD::Card->new(rank=>10, suit=>'C', val=>53)} 'new full bad val 2';
lives_ok {CDD::Card->new(rank=>'A', suit=>'S', val=>2)} 'new full lives';
lives_ok {CDD::Card->new('3D')} 'new short lives';

my $ace = CDD::Card->new('as');
...
my $six = CDD::Card->new('6H');
my $six2 = CDD::Card->new('6h');
