...
dies_ok {CDD::Card->new(rank=>10, suit=>'C', val=>0)} 'new bad val 1';
dies_ok {CDD::Card->new(rank=>10, suit=>'C', val=>53)} 'new bad val 2';
...
is $c->val, 2, 'get val';
is "$c", "AS", 'string context';
is $c->as_string, 'AS', 'as_string';
